...
int main()
{
    ...
    // const double ra = 18.6156478;
    // const double dec = 38.7836583;
    // const double pm_ra = 17.26;
    // const double pm_dec = 286.1;
    // const double parallax = 123.00;
    // const double rad_vel = -13.9;

    const std::string star_name = "Vega";
    const std::string catalog_name = "FK5";
    const short int num = 699;
    const double ra_hours = 18.6156478;
    const double dec_degrees = 38.7836583;
    const double pm_ra_mas_year = 150*1.726;
    const double pm_dec_mas_year = 10*28.61;
    const double parallax_mas = 1000*0.123;
    const double rad_vel_km_s = -13.9;
    ...
    */
    ...
    /*
    // Star configuration.
    const std::string star_name = "Spica";
    const std::string catalog_name = "FK5";
    const short int num = 498;
    const double ra = 13.4198852778;
    const double dec = -11.1613083333;
    const double pm_ra = 0;
    const double pm_dec = 0;
    const double parallax = 0;
    const double rad_vel = 0;
    */

    // Datetime configuration.
    const unsigned year = 2025;
    const short int month = 5;
    const short int day = 29;
    const short int hour = 22;
    const short int min = 10;
    const double sec = 28;
    ...
    const double x_pole = 0.1123147;
    const double y_pole = 0.43812793;
    const short int leap_secs = 37;  //R Difference between UTC and TAI (from 2017-01-01).
    const double ut1_utc = 0.02845033; // UT1 - UTC (2023-10-19)
    ...
    novas::make_cat_entry(name_ptr.data(), cat_ptr.data(), num, ra_hours, dec_degrees, pm_ra_mas_year,
                          pm_dec_mas_year, parallax_mas, rad_vel_km_s, &star);
    ...
    std::cout << "------------------------------------" << std::endl;
    std::cout << "AZ: " << std::fixed << std::setprecision(6) << az << std::endl;
    std::cout << "EL: " << std::fixed << std::setprecision(6) << el << std::endl;
    std::cout << "------------------------------------" << std::endl;
